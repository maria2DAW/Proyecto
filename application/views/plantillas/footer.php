...
<!-- Library -->
<script type="text/javascript" src="<?=base_url(); ?>assets/js/xing-wysihtml5-fb0cfe4/dist/wysihtml5-0.3.0.min.js"></script>
...
<script type="text/javascript" src="<?=base_url();?>assets/js/bootstrap-wysihtml5.js"></script>
